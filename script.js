const CONFIG = {
  ...
  starMessages: [
    ...
    "Gracias por existir",
    "Siempre elegiría encontrarte"
  ],
  finalMessage: "No importa cuántas estrellas existan, mi favorita siempre serás tú.",
  musicPath: "assets/music1.mp3"
};
...
function setupMusic() {
  els.music.addEventListener("canplay", () => {
    musicAvailable = true;
